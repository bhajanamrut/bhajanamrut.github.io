...
INDEX_FILE = "scripts/part2.js"
DIR = "bhajans/2"

def load_index():
    """Extract JS array from scripts/part1.js as Python list of dicts."""
    with open(INDEX_FILE, encoding="utf-8") as f:
        content = f.read()

    # Extract array content between [ and ]
    match = re.search(r"var p2\s*=\s*(\[[\s\S]*?\]);", content)
    if not match:
        raise ValueError("Could not parse part2.js")
